...
Un exemple del cas contrari, però, seria l'arxiu \texttt{words\_alpha} que conté totes les paraules d'un diccionari en anglès, una per línia. Aqui es fàcil veure que la indexació serà igual en un mode o en l'altre. 
Un cas particular de les entrades que hem fet servir per fer els nostres experiments és el cas de \texttt{dna\_genome}, un arxiu que conté aproximadamet 12.0 MB d'informació d'un genoma real humà. Aquest dataset difereix de la reta d'examples que hem fet servir en que es una unica string continua, sense espais ni marcadors pel final de paraula. 
