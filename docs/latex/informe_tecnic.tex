...
//ME GUSTARIA PONER EJEMPLO DE RADIX TREE CON EL TRee EXAMPLE ok mi siela haz la figura no. ok estaria bien hacerlas todas con el mismo formato no
\begin{figure}[H]
    \centering
...
Aquesta reducció es fará a través de la codificació binària del text.  
