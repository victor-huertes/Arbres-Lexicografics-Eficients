...
public:
    ...
    /**
     * @brief Calcula la memoria total usada por el Trie en bytes
...
private:
    /**
     * @brief Función auxiliar recursiva para calcular memoria de un nodo
     */
    size_t calculate_node_memory(RadixNode *node) const;
